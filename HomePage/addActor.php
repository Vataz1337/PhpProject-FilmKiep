...
if(isset($_POST['upload'])) {
    ...
    try {
        ...
        if ($connect->connect_errno != 0) {
            ...
            move_uploaded_file($tempname, "../actorImages/$imgname");
            if($connect->query("INSERT INTO actor (name, surname, birth, orgin, image) VALUES ('$name', '$surname', '$birth', '$orgin', '$imgname')")) {
                $_SESSION['upload'] = "Actor added!";
            }else {
...
<div class="mainContainer">
    <form action="addActor.php" method="post" enctype="multipart/form-data">
        <div class="titleText">
            Add actor
        </div>
        <div class="inputs">
            ...
            <div class="orgin">
                <label>
                    <input type="text" placeholder="Orgin of the actor" name="orgin" required>
                </label>
            </div>
            <div class="date">
                <label>
            ...
            <div class="submit">
                <input type="submit" value="Add actor" name="upload">
            </div>
            <?php
